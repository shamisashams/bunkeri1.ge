        ...
        <div className="content ">
          ...
          <div className="flex main">
            <div className="form">
              ...
              <input type="text" maxLength="16" className="common_input" />
              <div className="flex expiration">
                <div className="op05">მოქმედების ვადა</div>
                <div className="flex">
                  <input type="text" maxLength="2" className="common_input" />
              ...
              <div className="flex cvv">
                <div className="op05">მოქმედების ვადა</div>
                <input type="text" maxLength="3" className="common_input" />
              </div>
              <YellowButton link="/success" text="გადახდა" />
            </div>
                ...
                {costs.map((el, i) => {
                  return (
                    <p className="flex" key={i}>
                      <span>{el.item}</span> <span>{el.cost}₾</span>
                    </p>
                  );
                })}
              </div>
