            ...
            <div className="productDetails">
                ...
                <div className="flex main">
                    ...
                    <div className="details">
                        ...
                        >
                            {product.quantity > 0
                                ? __("client.instock", sharedData)
                                : __("client.nostock", sharedData)}
                            <img
                        ...
                        <div className="archy-edt title">{product.title}</div>
                        <div className="op05">
                            მწარმოებელი: <span>{product_attributes.brand}</span>
                        </div>
                        <div className="blue price">{(product.special_price !== null ? parseFloat(product.special_price) : parseFloat(product.price)).toFixed(2)} ლარი</div>
                        <div className="btns">
                            <div className="flex">
                        ...
                        <div className="flex share blue">
                            ...
                            <span>
                                {__("client.share_product", sharedData)}
                            </span>
                        </div>
                        <div className="archy-edt title">
                            {__("client.product_description", sharedData)}
                        </div>
                        <div className="op05">
